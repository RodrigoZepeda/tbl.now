...
#
# `plot_epidemic_process()`, `plot_transport_timeline()` and
# `plot_delay_band_ternary()` were dropped from the package. They still rely on
# package internals; to run them, load the package first and source this file:
#
#   devtools::load_all(".")
