...
#'
#' @description These functions extract the attributes from a `tbl_now` object.
...
#This one gets the columns that should not be dropped by dplyr
#' @keywords internal
...
#' These refer to the columns given by the user
#' @keywords internal
