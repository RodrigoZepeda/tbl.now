...
#'
#' # A few months and a short delay keep the example quick; preprocessing the
#' # whole series with `max_delay = 40` takes several seconds.
#' recent <- obs[reference_date >= as.Date("2021-09-01")]
