...
gap between
[get_latest_reported_cases()](https://rodrigozepeda.github.io/tbl.now/reference/get_latest_first.md)
and `get_latest_revised_cases()` is the backlog the laboratory still
owes you.
...
- x:
  ...
  A `tbl_now` with a revision process (see
...
began. If you want counts by revision date instead, group on
`get_revision_date(x)` yourself – that is a different question (how busy
...
`get_nth_revised_cases(x, 7)` describe the same seven days and can be
read against each other. It is deliberately *not* `.revision_delay`,
...
#>   [event_date] [report_d…      [...]       [...] [revision… [revis… [cas…  [...]
#> 1 2021-01-04   2021-01-05          0           1 2021-01-06 confir…     1      1
#> 2 2021-01-05   2021-01-06          1           2 2021-01-07 confir…     2      1
#> # ────────────────────────────────────────────────────────────────────────────────
#> # Now: 2021-01-08 | Event date: "onset" | Report date: "visit"
#> # Revision date: "result" ("days") | resolved: 2/2
#> # ────────────────────────────────────────────────────────────────────────────────
#> # ℹ 2 more variables: .revision_num <dbl>, .revision_delay <dbl>
...
#> # ────────────────────────────────────────────────────────────────────────────────
#> # Now: 2021-01-08 | Event date: "onset" | Report date: "visit"
#> # Revision date: "result" ("days") | resolved: 0/3
#> # ────────────────────────────────────────────────────────────────────────────────
#> # ℹ 2 more variables: .revision_num <dbl>, .revision_delay <dbl>
...
#> # ────────────────────────────────────────────────────────────────────────────────
#> # Now: 2021-01-08 | Event date: "onset" | Report date: "visit"
#> # Revision date: "result" ("days") | resolved: 4/4
#> # ────────────────────────────────────────────────────────────────────────────────
#> # ℹ 2 more variables: .revision_num <dbl>, .revision_delay <dbl>
