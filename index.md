...
uses this to tell the two apart, per report date:
...
adds a complementary check on whether a flagged date drew on unusually
*old* event dates. These functions are experimental — see the *Batch
detection* article.
